...
How to Run
Generate Data: Open data_generation.ipynb and run the simulation engine to generate the CSV datasets.

Analyze and Explore: 
Open Showcase_Analysis.ipynb. This notebook will automatically ingest the generated CSV files.
Follow the "Analytical Playground" (Chapter 2) to visualize demand curves, and "Predictive Modeling" (Chapter 3) to test your own pricing hypotheses.
